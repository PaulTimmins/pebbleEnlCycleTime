...
void handle_conn(bool connected) {
	...
	if (connected) {
    #ifdef PBL_COLOR
       text_layer_set_background_color(tl_conn_layer, GColorIslamicGreen);
    #else 
...
void handle_init(void) {
  ...
  #ifdef PBL_COLOR
    text_layer_set_background_color(tl_cycle, GColorIslamicGreen);
	...
	#ifdef PBL_COLOR
    text_layer_set_background_color(tl_cp, GColorIslamicGreen);
	...
	#ifdef PBL_COLOR
    text_layer_set_background_color(tl_countdown, GColorIslamicGreen);
	...
	#ifdef PBL_COLOR
    text_layer_set_background_color(tl_list, GColorIslamicGreen);
...
#ifdef PBL_COLOR
  bitmap_layer_set_background_color(bl_res, GColorIslamicGreen);
#else
  ...
  tl_realtime = text_layer_create(GRect(55, 60, frame.size.w-60, 20));
	...
	#ifdef PBL_COLOR
    text_layer_set_background_color(tl_realtime, GColorIslamicGreen);
  ...
  text_layer_set_font(tl_batt_layer, font_s);
	...
	#ifdef PBL_COLOR
    text_layer_set_background_color(tl_batt_layer, GColorIslamicGreen);
    text_layer_set_text_color(tl_batt_layer, GColorWhite);
  #else
    text_layer_set_background_color(tl_batt_layer, GColorBlack);
    text_layer_set_text_color(tl_batt_layer, GColorWhite);
	...
	#ifdef PBL_COLOR
    text_layer_set_background_color(tl_region_layer, GColorIslamicGreen);
